...
export const API = {
    ...
    async getPermissions(token, email) {
        const response = await axios.get(`${backendUrl}/sso/getUserPermession`, {headers: {"Access-Token": token, "Email": email}})
        return response;
    },

    async createSelector(email, id, password, realName, role, token, tokenCreateDate, userName, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/sso/addUser`, {email: email, id: id, password: password, realName: realName, role: role, token: token, tokenCreateDate: tokenCreateDate, userName: userName}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async deleteSelector(user, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/sso/deleteUser`, user, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async getAllUser(accessToken, accessEmail) {
        const response = await axios.get(`${backendUrl}/sso/getAllUser`, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async deleteCompetition(compId, accessToken, accessEmail) {
        const response = await axios.post(`h${backendUrl}/competition/deleteCompetitionById`, {id: compId}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },
    ...
    async updateCompetition(teamId, compId, competitionDays, competitionName, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/competition/updateCompetition`, {teamId: teamId, id: compId, competitionDays: competitionDays, competitionName: competitionName}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },
    ...
    async getAllTeams(accessToken, accessEmail) {
        const response = await axios.get(`${backendUrl}/team/getAllTeam`, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async getPlayerById(playerId, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/getPlayerById`, {id: playerId}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async getAllCompetitions(accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/competition/getAllCompetition`, {}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async createNewCompetition(day, days, name, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/competition/addCompetition`, {competitionDay: day, competitionDays: days, competitionName: name, teamId: 0}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },
    ...
    async getAllPlayers(availability, maxPerformance, minPerformance, sortOrder, sortField, favPosition, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/getAllPlayer`, {searching: {availability: availability, maxScore: maxPerformance, minScore: minPerformance, order: {direction: sortOrder, sortField: sortField}, position: favPosition}}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async deletePerformanceById(competitionId, performanceId, matchTime, performanceScore, playerId, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/deleteMatchPerformanceById`, {competitionId: competitionId, id: performanceId, matchTime: matchTime, performanceScore: performanceScore, playerId: playerId}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },
    ...
    async getFilteredUserPerformances(competitionId, season, playerId, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/getUserPerformancesByFilter`, {paging: {currentPage: 0, pageSize: 0, total:0}, searching: {competitionId: competitionId, season: season, playerId: playerId}}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async updatePlayer(playerDetails, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/updatePlayer`, playerDetails, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async getAllPlayerPerformances(playerId, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/getUserPerformances`, {paging: {currentPage: 0, pageSize: 0, total:0}, searching: {playerId: playerId}}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },

    async deletePlayerById(playerId, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/deletePlayerById`, {id: playerId}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response;
    },
    ...
    async getTeamMembersPhotoURL(team, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/team/getTeamPlayerPhotos`, team, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response
    },

    async addMatchPerformance(compId, compName, matchTime, performanceScore, playerId, position, season, accessToken, accessEmail) {
        const response = await axios.post(`${backendUrl}/player/addMatchPerformance`, {competitionId: compId, competitionName: compName, matchTime: matchTime, performanceScore: performanceScore, playerId: playerId, position: position, season: season}, {headers: {"Access-Token": accessToken, "Email": accessEmail}})
        return response
    },
